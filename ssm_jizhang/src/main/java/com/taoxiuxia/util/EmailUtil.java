...
public class EmailUtil {
	...
	public static String sendEmail(String emailTo) {  //收件人，多个收件人以半角逗号分隔
		String userName = "yuanmamatouemail@163.com"; // 发件人邮箱
		String password = "yuanmamatou1234"; // 发件人密码
		String smtpHost = "smtp.163.com"; // 邮件服务器

		String subject = "天天记账本激活码"; // 主题
		String activationCode = activationCode();
		String body = "您正在注册天天记账本<br>这是您的激活码，3小时内有效<br><b>"+activationCode+"</b>"; // 正文，html格式
